    ...
    <div class=" container estructura mt-4" id="modelos">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12 p-1">
                <div class="d-grid gap-2">
                    <input type="submit" class="btn btn-primary" value="Filtrar" name="enviar">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12 p-1">
                <div class="d-grid gap-2">
                    <a class="btn btn-danger" href="admin.php">Reset</a>
                </div>
            </div>
            </form>
        </div>
        <div class="row ">
            <div class="col-12 p-1 w-100">
                <a class="btn btn-success w-100" href="agregar.php">Agregar</a>
            </div>
        </div>
    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <form method="POST" action="editar2.php">
                                            <input type="hidden" name="id" value="<?php $fila["id"] ?>">
                            ...
                            <nav class="mt-4">
                                <ul class="pagination justify-content-center">
                                    ...
                                    for ($i = 1; $i <= $total_paginas; $i++) {
                                        ...
                                        if ($pagina == $i) {
                                            echo "<li class='page-item active'><a class='page-link disabled' href='admin.php?pagina=" . $i . "'>" . $i . "</a></li>";
                                        } else {
                                            // Creamos el enlace a cada página sin la clase active.
                                            echo "<li class='page-item'><a class='page-link' href='admin.php?pagina=" . $i . "'>" . $i . "</a></li>";
                                        }
                                    }
                                    ?>
                                </ul>
